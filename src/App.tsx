...
import TenantStatementsPage from '@/pages/finance/TenantStatementsPage'
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/finance/tenant-statements" element={<ProtectedRoute><TenantStatementsPage /></ProtectedRoute>} />
